const contractAddress = "0x63451e1956D34151509D0473227dfB50F493B509"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to IndieCats Club NFT Project!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'IndieCats are your access pass to a global Create-To-Earn community & Project platform for independent filmmakers, actors, and production professionals; Indieverse.';
const h1_presale_coming_soon = "NFT Drop Coming Soon!";
const h1_presale_mint = "Pre-Sale Minting Open!";
const h1_public_mint = "Public Minting Opennp!";
